...
for seed in 1 ; do
  XLA_PYTHON_CLIENT_MEM_FRACTION=.95 MUJOCO_GL=egl CUDA_VISIBLE_DEVICES=0 python main.py "$method" \
    --wandb_project_name sudoku-bmm --wandb_group categorical_actor --exp_name ${env}_categorical_${total_env_steps}_${batch_size}_${num_envs}_${train_step_multiplier}_${repetition_factor}_${seed} --num_evals 1000 \
