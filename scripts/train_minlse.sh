...
for seed in 1 ; do
  XLA_PYTHON_CLIENT_MEM_FRACTION=.95 MUJOCO_GL=egl CUDA_VISIBLE_DEVICES=0 python training_minlse.py \
    --project_name test --group_name first_run --exp_name ${env}-minlse --num_evals 50 \
