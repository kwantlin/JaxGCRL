...
def main(config: Config):
    ...
    metrics_to_collect = [
        ...
        "eval/episode_valid_move",
        "eval/episode_correct_move",
        "eval/episode_incorrect_move",
        "eval/episode_cells_remaining",
        "eval/episode_completion_percentage",
        "eval/episode_distance_to_solution",
        "eval/episode_moves_made",
        "eval/episode_quarter_complete",
        "eval/episode_half_complete",
        "eval/episode_three_quarters_complete",
        "eval/episode_almost_complete",
        "eval/episode_initial_clues",
        "eval/episode_puzzle_difficulty",
        "eval/episode_initial_distance_to_solution",
